package helpers.ble.initializers;
...
import cmars.blehelperslib.R;
import helpers.LocationHelper;
import helpers.PermissionsHelper;
...
public class BleInitializerM extends BleInitializerL {
    ...
    public BleInitializerM(Activity activity, InitCompletionCallback initCompletionCallback) {
